                        ...
                        <div class="sl-form__wrap">
                            <div class="form-group form-group-half">
                                <label data-provide="datepicker">
                                    <input type="text" id="sl-startdate" name="fullname" value="<?=$user->name?>" class="form-control sl-form-control" placeholder="Full Name">
                                    <a href="javascript:void(0);" class="sl-calendarbtn sl-right-icon"></a>
                                </label>
                            </div>
                            <div class="form-group form-group-half">
                                <label>
                                    <input type="text" value="<?=@$basicInfo->mobile?>" name="mobile"  class="form-control sl-form-control" placeholder="Mobile">
                                    <a href="javascript:void(0);" class="sl-calendarbtn sl-right-icon"></a>
                                </label>
                            </div>
                            <div class="form-group form-group-half">
                                <label>
                                    <input type="text" value="<?=@$basicInfo->postal_code?>" id="postal_code" name="postal_code"  class="form-control sl-form-control" placeholder="Mobile">
                                    <a href="javascript:void(0);" class="sl-calendarbtn sl-right-icon"></a>
                                </label>
                            </div>
                            <div class="form-group form-group-half">
                                <label>
                                    <select id="sl-intervals" class="form-control sl-form-control" name="birth_year">

                                        <option selected disabled hidden>Select Birth Year</option>
                                        @php
                                            $year = 2020;
                                            for(;$year > 1960; $year--){
                                        @endphp
                            ...
                            <div class="form-group form-group-half">
                                <label>
                                    <select id="sl-appointment-duration" class="form-control sl-form-control" name="race">
                                        <option selected disabled hidden>Choose Race</option>
                            ...
                            <div class="form-group form-group-half">
                                <label>
                                    <select id="sl-intervals" class="form-control sl-form-control" name="citizenship">

                                        <option selected disabled hidden>Choose Citizenship</option>
                            ...
                            <div class="form-group form-group-half">
                                <label>
                                    <select id="sl-appointment-duration" class="form-control sl-form-control" name="country">
                            ...
                            <div class="form-group form-group-half">
                                <label>
                                    <select id="sl-appointment-duration" class="form-control sl-form-control" name="gender">
